import React, { JSX, useEffect } from 'react'; // ****************** useEffect  추가
import { useGLTF, useTexture } from '@react-three/drei'; // ****************** useTexture 추가
...
//  JSX.IntrinsicElements['group'] 타입 적용
export default function Model(props: JSX.IntrinsicElements['group']) {
    const { nodes, materials } = useGLTF(
        '/models/scene.glb'
    ) as unknown as GLTFResult;

    const texture = useTexture(props.item.img); // ********************* 전달된 모델 색상
